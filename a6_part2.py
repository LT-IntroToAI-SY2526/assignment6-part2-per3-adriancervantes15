...
def visualize_features(data):
    ...
    fig.suptitle('House Feature vs Price', fontsize=16, fontweight='bold')
    ...
    axes[0, 1].set_xlabel('Bedrooms (rooms)')
    ...
    axes[1, 0].set_xlabel('Bathrooms (rooms)')
...
def prepare_features(data):
    ...
    feature_Col = ['SquareFeet', 'Bedrooms', 'Bathrooms', 'Age']
...
def make_prediction(model, sqft, bedrooms, bathrooms, age):
    ...
    print(f"\n=== New Prediction ===")
    print(f"House specs: {sqft:.0f} square feet, {bedrooms} bedrooms, {bathrooms} bathrooms, {age} years")
